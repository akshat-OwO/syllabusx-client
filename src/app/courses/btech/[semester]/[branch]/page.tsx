...
const Page: FC<pageProps> = ({}) => {
    ...
    return (
        <LayoutWrapper className='min-h-[calc(100vh-8.5rem)] py-20'>
            <div className="grid gap-4 w-full sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                <div className="prose dark:prose-invert prose-neutral self-center">
                ...
                {isLoading && (
                    <Loader2 className="h-24 w-24 animate-spin mx-auto sm:col-span-2 md:col-span-3 lg:col-span-4" />
                )}
                {data && !(data.length > 0) && (
